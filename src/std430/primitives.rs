...
unsafe impl Std430 for GlslBoolean {
    const ALIGNMENT: usize = 4;
}
...
vectors! {
    ...
    #[doc = "Corresponds to a GLSL `bvec2` in std430 layout."] align(8) bvec2 BVec2<GlslBoolean>(x, y)
    #[doc = "Corresponds to a GLSL `bvec3` in std430 layout."] align(16) bvec3 BVec3<GlslBoolean>(x, y, z)
    #[doc = "Corresponds to a GLSL `bvec4` in std430 layout."] align(16) bvec4 BVec4<GlslBoolean>(x, y, z, w)
